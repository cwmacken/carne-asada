            ...
            <div>
                ...
                <Grid>
                    ...
                    <Row>
                        <Col xs={12}>
                            Password:
                            <input type="password" onChange={this.handleChangePasswordOne}/>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={12}>
                            Password Confirm:
                            <input type="password" onChange={this.handleChangePasswordTwo}/>
                        </Col>
                    </Row>
                    <Row>
                        <Col xs={12}>
...
const mapStateToProps = (state) => {
    ...
    return {number: state.sampleOne.num, name: state.sampleTwo.name, auth: state.auth}
}
...
const App = connect(mapStateToProps, mapDispatchToProps)(Signup)
